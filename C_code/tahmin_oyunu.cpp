...
int A=0,B=0,t_sure=0,fark=0,sira=1;
    ...
    int main (int argc,char *argv[]){
        ...
        while(1==1){
        	sira=1;
                time(&start);
                printf("\noyuncu1 [%d-%d] arasi tahminini girsin : ",min,max);scanf("%d",&oyuncu1);fflush(stdin);
                time(&final);
                ...
                if(oyuncu1>=min && oyuncu1<=max){
                	if(oyuncu1==rdeger){
                        ...
                        time(&start);
                            ...
                            if(oyuncu2>=min && oyuncu2<=max){
                            	if(oyuncu2 == rdeger){
                            		 printf("\nDogru. Oyuncu2 kaybetti gecen sure %d",fark);
                                    fprintf(dosya,"\noyuncu2 tahmin: %d\noyuncu2 gecen sure: %d\n ",oyuncu2,fark);
                                    fprintf(dosya,"\nkazanan: oyuncu1");
                                    flag=1;
                                    break;  
					...
					printf("\nOyuncu1 belirtilen aralikta tahmin girmedi. Kazanan oyuncu2");
